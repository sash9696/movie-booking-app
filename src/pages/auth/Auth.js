  ...
  const validateData = (data) => {
    ...
    if (data.name) {
      if (data.name.length < 5 || data.name.length > 10) {
        setErrorMessage("Username shou be 5 to 10 characters long");
      }
  ...
  return (
    <div id="loginPage">
      <div className="bg-dark d-flex justify-content-center align-items-center vh-100">
        <div className="card m-5 p-5 bg-dark text-light shadow-lg d-flex align-items-center justify-content-center vh-100">
          <div className="row m-2">
            <div>
              ...
              <form onSubmit={showSignup ? signupFn : loginFn}>
                ...
                {showSignup && (
                  <>
                    ...
                    <div className="row m-1">
                      <div className="col">
                        <span className="my-1 mx-1">User Type</span>
                      </div>
                      <div className="col">
                        <DropdownButton
                          align="end"
                ...
                <div onClick={toggleSignup} className="signup-btn text-center">
                  {showSignup
