  ...
  return (
    <div className="shadow-lg">
      <CCarousel controls>
        ...
        <CCarouselItem>
          <CImage className="d-block w-100" src={Two} alt="slide 1" />
        </CCarouselItem>
        <CCarouselItem>
          <CImage className="d-block w-100" src={Three} alt="slide 1" />
        </CCarouselItem>
        <CCarouselItem>
          <CImage className="d-block w-100" src={Four} alt="slide 1" />
        </CCarouselItem>
      </CCarousel>
    </div>
  );
